            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDEO 4/wpu-hut/latihan2.html" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDEO 5/index.html" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>   
          </div>
            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDEO 6/index.php" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div> 
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDEO7/" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>
